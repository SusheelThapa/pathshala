      ...
      <ul className="h-full space-y-4 text-xl w-full ml-6">
        {sidebarList.map(({ icon, title }) => (
          <li
            ...
            className={`w-full py-3 pl-2 rounded-xl flex justify-start items-center space-x-2 cursor-pointer ${
          ...
          >
            <div
              className={`mr-3 p-1 rounded-lg w-9 h-9 flex justify-center items-center text-2xl font-black ${
                selectedChannel === title
